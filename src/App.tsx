...
import { Heart, Mic, Phone, Type, Package, ChevronDown, PlayCircle, AlertCircle, Target, Compass, Eye, Mail, Globe, Github, ShoppingBag } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">Rapid Relief</h1>
            </div>
            <button
          ...
          <div className="mt-12 pt-8 border-t border-red-100">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              ...
              <div className="flex items-center space-x-6">
                <a href="https://en.wikipedia.org/wiki/Survival_kit" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-red-500 transition-colors">
                  <Globe className="h-5 w-5" />
                </a>
                <a href="https://www.amazon.in/Survival-Kit/s?k=Survival+Kit" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-red-500 transition-colors">
                  <ShoppingBag className="h-5 w-5" />
                </a>
                <a href="https://www.redcross.org/get-help/how-to-prepare-for-emergencies/survival-kit-supplies.html?srsltid=AfmBOorPv0AHOXfxy5biGgJWE0tTDGVEwK3R7x2JW_QGcpKPVMv3t3Qn" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-red-500 transition-colors">
                  <Globe className="h-5 w-5" />
                </a>
              </div>
            </div>
            ...
            <div className="mt-8 text-center text-sm text-gray-600">
              <p>© {new Date().getFullYear()} RapidRelief</p>
              <p className="mt-2">
